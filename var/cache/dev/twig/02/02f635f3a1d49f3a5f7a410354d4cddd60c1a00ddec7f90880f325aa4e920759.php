...
class __TwigTemplate_fbb77ffcd46b990cdf32866a61df6c42a0ed82c9d3e1530d7bc3eb99021d3eec extends Template
{
    private $source;
    private $macros = [];
...
{% else %}
    <a href=\"mailto:{{ field.value }}\">{{ field.formattedValue }}</a>
{% endif %}
", "@EasyAdmin/crud/field/email.html.twig", "/home/anthony/Documents/Test-api (W en cours)/back-api/vendor/easycorp/easyadmin-bundle/src/Resources/views/crud/field/email.html.twig");
    }
}
